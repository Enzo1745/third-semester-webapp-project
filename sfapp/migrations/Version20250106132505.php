 ...
 */
final class Version20250106132505 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE comfort_instruction_room (id INT AUTO_INCREMENT NOT NULL, room_id INT NOT NULL, comfort_instruction_id INT NOT NULL, INDEX IDX_78D2A23D54177093 (room_id), INDEX IDX_78D2A23D50D9B130 (comfort_instruction_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE sa (id INT NOT NULL, room_id INT DEFAULT NULL, state VARCHAR(255) NOT NULL, temperature INT DEFAULT NULL, humidity INT DEFAULT NULL, co2 INT DEFAULT NULL, UNIQUE INDEX UNIQ_7F7E690454177093 (room_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
